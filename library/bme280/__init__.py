...
class BME280Calibration:
    ...
    def compensate_temperature(self, raw_temperature):
        ...
        self.temperature_fine = (var1 + var2) + self.offset_temp_in_t_fine
        return self.temperature_fine / 5120.0

    def compensate_pressure(self, raw_pressure):
        var1 = (self.temperature_fine - self.offset_temp_in_t_fine) / 2.0 - 64000.0
    ...
    def compensate_humidity(self, raw_humidity):
        var1 = self.temperature_fine - self.offset_temp_in_t_fine - 76800.0
...
class BME280:
                ...
                Register(
                    ...
                    fields=(
                        BitField(
                            ...
                            adapter=LookupAdapter({1: 0b001, 2: 0b010, 4: 0b011, 8: 0b100, 16: 0b101}),
                        ),
                        BitField(
                            "osrs_p",
                        ...
                        BitField(
                            ...
                            adapter=LookupAdapter({"sleep": 0b00, "forced": 0b10, "normal": 0b11}),
                        ),
                    ),
                ),
                Register(
    ...
    def setup(
        ...
        try:
            ...
            if chip.id != CHIP_ID:
                raise RuntimeError(
                    "Unable to find bme280 on 0x{:02x}, CHIP_ID returned {:02x}".format(self._i2c_addr, chip.id)
                )
        except OSError:
        ...
        self._bme280.set("CONFIG", t_sb=temperature_standby, filter=1)
    ...
    def get_data(self, qnh=1013.25):
        print("{:05.2f}*C {:05.2f}hPa {:05.2f}%".format(temperature, pressure, humidity))
        data = {
            "temperature_C": f"{self.temperature:05.2f}",
            "humidity": f"{self.humidity:05.2f}",
            "pressure": f"{self.pressure:05.2f}",
        }
        return data
